    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Link href="/abrir-empresa">
                <Button className="bg-white text-blue-600 hover:bg-blue-50">Começar Agora</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <Badge className="mb-6 bg-blue-100 text-blue-700 hover:bg-blue-100">Sobre o Projeto</Badge>
          <h2 className="text-5xl font-bold text-gray-900 mb-6 text-balance">
            Conheça o<span className="text-blue-600"> FACILITA</span>
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto text-pretty">
            Uma plataforma inovadora criada para revolucionar a gestão de processos empresariais no Brasil, tornando a
            abertura, alteração e fechamento de CNPJ mais simples e eficiente.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Nossa Missão</h3>
