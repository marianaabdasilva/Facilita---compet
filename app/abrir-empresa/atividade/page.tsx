...
export default function AtividadePage() {
  ...
  try {
    ...
    const { data: cnpjData } = await axios.post(
      "https://facilita-compet.vercel.app/cadastrarcnpj",
    ...
    await axios.post(
      `https://facilita-compet.vercel.app/adicionarcnpjcliente/${selectedClient.id_cliente}`,
      { cnpj_id },
      { headers: { Authorization: `Bearer ${token}` } }
    );
    ...
    for (const cnae of selectedCnaes) {
      await axios.post(
        "https://facilita-compet.vercel.app/cnaes_cliente",
    ...
    const { data: enderecoData } = await axios.post(
      "https://facilita-compet.vercel.app/adicionar_endereco_vazio",
    ...
    if (!useDifferentAddress) {
      await axios.put(
        "https://facilita-compet.vercel.app/atualizar-endereco-cliente",
